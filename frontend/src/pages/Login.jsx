          ...
          {!showAdminLogin ? (
            <div className="space-y-6">
              <div className="text-center mb-6">
                <p className="text-amber-400 font-medium bg-amber-400/10 p-3 rounded-lg border border-amber-400/20 text-sm">
                  ระบบล็อคอินด้วย Discord ปิดปรับปรุงชั่วคราว<br/>
                  (เซิร์ฟเวอร์ติด Limit การเชื่อมต่อ)<br/>
                  กรุณารอประมาณ 30-60 นาที
                </p>
              </div>

              <button
                disabled={true}
                className="group relative flex w-full items-center justify-center gap-3 rounded-xl bg-slate-700 px-4 py-4 font-semibold text-white opacity-70 cursor-not-allowed"
              >
